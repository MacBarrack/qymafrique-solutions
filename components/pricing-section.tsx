      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          ...
          <p className="md:max-w-xs text-gray-500 text-sm leading-relaxed">
            Clear, competitive pricing for quality digital solutions. All prices are estimates — final pricing confirmed after consultation.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {plans.map((p) => (
            <div
              key={p.name}
              className={`rounded-3xl p-5 sm:p-6 flex flex-col gap-4 transition-all duration-200 ${
                p.featured
            ...
            >
              <div>
                <p
                  className={`text-[10px] font-bold uppercase tracking-widest mb-2 ${
                    p.featured ? "text-blue-400" : "text-gray-400"
                  }`}
                >
                ...
                <p className={`text-2xl font-black ${p.featured ? "text-white" : "text-black"}`}>
                  {p.price}
                </p>
                <p className="text-[10px] mt-0.5 text-gray-400">starting at</p>
              </div>
              ...
              <ul className="space-y-2 flex-1">
                {p.features.map(f => (
                  <li key={f} className="flex items-start gap-2">
                    ...
                    />
                    <span className={`text-xs ${p.featured ? "text-gray-300" : "text-gray-600"}`}>
                      {f}
                    </span>
                  </li>
                ))}
              ...
              <Link href="/quote">
                <span
                  className={`flex items-center justify-center gap-2 py-3 rounded-2xl text-xs font-bold transition-colors ${
                    p.featured
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 max-w-lg leading-relaxed">
              We also offer print &amp; packaging design, custom integrations, and ongoing maintenance packages. Contact us for a personalised quote.
            </p>
          </div>
