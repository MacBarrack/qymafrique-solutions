      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
            ...
            <div className="grid lg:grid-cols-5 min-h-[520px]">
              ...
              <div className="lg:col-span-2 bg-gray-950 relative flex items-center justify-center p-8 min-h-[280px]">
                ...
                <div className="relative z-10 w-full max-w-xs">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-3 backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-8 h-8 rounded-xl bg-blue-600 flex items-center justify-center">
                        <Zap className="w-4 h-4 text-white" />
                      </div>
                      <div>
                        <p className="text-white text-xs font-bold">Project Live</p>
                        <p className="text-gray-400 text-[10px]">Twin Compass Tours</p>
                      </div>
                      ...
                      {[80, 60, 90].map((w, i) => (
                        <div key={i} className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${w}%`, transition: "width 1s ease", transitionDelay: `${i * 0.2}s` }}
                          />
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <div key={l} className="bg-white/5 border border-white/10 rounded-xl p-3 text-center backdrop-blur-sm">
                        ...
                        <p className="text-gray-400 text-[9px] mt-0.5">{l}</p>
                      </div>
                    ))}
                  </div>

                  <div className="mt-3 bg-blue-600 rounded-2xl p-4">
            ...
            <div className="border-t border-gray-100 px-8 sm:px-12 lg:px-16 py-4">
